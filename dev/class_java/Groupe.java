...
public class Groupe {
    ...
    private int groupe_Effectif;
    private boolean groupe_Actif;
    ...
    public Groupe( int code_groupe,  int code_campagne,  String groupe_Nom,  String groupe_Description,  String groupe_Logo_Fichier,  int groupe_Effectif,  boolean groupe_Actif,  String groupe_Date_creation,  int groupe_Delai_suppression_jour,  boolean groupe_Suppression_active ) {
    ...
    public int get_groupe_Effectif() { return this.groupe_Effectif; }
    public boolean get_groupe_Actif() { return this.groupe_Actif; }
    ...
    public void set_groupe_Effectif( int groupe_Effectif ) { this.groupe_Effectif = groupe_Effectif; }
    public void set_groupe_Actif( boolean groupe_Actif ) { this.groupe_Actif = groupe_Actif; }
