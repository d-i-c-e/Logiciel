...
class Hook_a_candidature_joueur_groupe{
    ...
    static function hook_actualiser_les_droits_ajouter($Code_joueur=0, $Code_groupe=0)
    {
         ...
         * Droits disponibles :
         *
         * $mf_droits_defaut['a_candidature_joueur_groupe__AJOUTER']
         * $mf_droits_defaut['a_candidature_joueur_groupe__CREER'] // actualisation uniquement pour l'affichage
         *
         */
        // ici le code
    }
    ...
    static function hook_actualiser_les_droits_modifier($Code_joueur=0, $Code_groupe=0)
    {
         ...
         * Droits disponibles :
         *
         * $mf_droits_defaut['a_candidature_joueur_groupe__MODIFIER']
         *
         * $mf_droits_defaut['api_modifier__a_candidature_joueur_groupe_Message']
         * $mf_droits_defaut['api_modifier__a_candidature_joueur_groupe_Date_envoi']
         *
         */
        // ici le code
    }
    ...
    static function hook_actualiser_les_droits_supprimer($Code_joueur=0, $Code_groupe=0)
    {
         ...
         * Droits disponibles :
         *
         * $mf_droits_defaut['a_candidature_joueur_groupe__SUPPRIMER']
         *
         */
        // Ici le code
    ...
    static function completion(&$donnees)
    {
         ...
         * $donnees['Code_joueur']
         * $donnees['Code_groupe']
         * $donnees['a_candidature_joueur_groupe_Message']
         * $donnees['a_candidature_joueur_groupe_Date_envoi']
         */
        // ici le code
    }
