...
class tag_campagne_monframework extends entite_monframework
{
    ...
    public function mf_ajouter(string $tag_campagne_Libelle, ?bool $force=false)
    {
    ...
    public function mf_ajouter_2(array $ligne, bool $force=null) // array('colonne1' => 'valeur1',  [...] )
    {
        if ( $force===null ) { $force=false; }
        global $mf_initialisation;
        $tag_campagne_Libelle = (string)(isset($ligne['tag_campagne_Libelle'])?$ligne['tag_campagne_Libelle']:$mf_initialisation['tag_campagne_Libelle']);
        return $this->mf_ajouter($tag_campagne_Libelle, $force);
    }
    ...
    public function mf_modifier( int $Code_tag_campagne, string $tag_campagne_Libelle, ?bool $force=null)
    {
        if ( $force===null ) { $force=false; }
        $code_erreur = 0;
    ...
    public function mf_modifier_2(array $lignes, ?bool $force=null) // array( $Code_tag_campagne => array('colonne1' => 'valeur1',  [...] ) )
    {
        if ( $force===null ) { $force=false; }
        $code_erreur = 0;
        foreach ( $lignes as $Code_tag_campagne => $colonnes )
        {
            if ( $code_erreur==0 )
            {
                $Code_tag_campagne = (int)round($Code_tag_campagne);
                ...
                $tag_campagne_Libelle = (string)( isset($colonnes['tag_campagne_Libelle']) && ( $force || mf_matrice_droits(['api_modifier__tag_campagne_Libelle', 'tag_campagne__MODIFIER']) ) ? $colonnes['tag_campagne_Libelle'] : ( isset($tag_campagne['tag_campagne_Libelle']) ? $tag_campagne['tag_campagne_Libelle'] : '' ) );
    ...
    public function mf_modifier_3(array $lignes) // array( $Code_tag_campagne => array('colonne1' => 'valeur1',  [...] ) )
    {
        $code_erreur = 0;
        $modifs = false;
    ...
    public function mf_modifier_4( array $data, ?array $options = null /* $options = array( 'cond_mysql' => array(), 'limit' => 0 ) */ ) // $data = array('colonne1' => 'valeur1', ... )
    {
        ...
        if ( count($mf_colonnes_a_modifier)>0 )
        {
            ...
            $requete = 'UPDATE ' . inst('tag_campagne') . ' SET ' . enumeration($mf_colonnes_a_modifier) . " WHERE 1$argument_cond" . ( $limit>0 ? ' LIMIT ' . $limit : '' ) . ";";
            $cle = md5($requete).salt(10);
            self::$cache_db->pause($cle);
            executer_requete_mysql( $requete , true);
            if ( requete_mysqli_affected_rows()==0 )
    ...
    public function mf_supprimer( int $Code_tag_campagne, ?bool $force=null )
    {
        if ( $force===null ) { $force=false; }
        $code_erreur = 0;
        $Code_tag_campagne = round($Code_tag_campagne);
    ...
    public function mf_supprimer_2(array $liste_Code_tag_campagne, ?bool $force=null)
    {
        if ( $force===null ) { $force=false; }
        $code_erreur=0;
    ...
    public function mf_supprimer_3(array $liste_Code_tag_campagne)
    {
        $code_erreur=0;
    ...
    public function mf_lister_2(array $liste_Code_tag_campagne, ?array $options = null /* $options = [ 'cond_mysql' => [], 'tris' => [], 'limit' => [], 'toutes_colonnes' => TOUTES_COLONNES_DEFAUT, 'autocompletion' => AUTOCOMPLETION_DEFAUT, 'controle_acces_donnees' => CONTROLE_ACCES_DONNEES_DEFAUT, 'maj' => true ] */)
    {
        if ( $options===null ) { $options=[]; }
        if ( count($liste_Code_tag_campagne)>0 )
        {
    ...
    public function mf_get(int $Code_tag_campagne, ?array $options = null /* $options = [ 'autocompletion' => AUTOCOMPLETION_DEFAUT, 'toutes_colonnes' => true, 'maj' => true ] */)
    {
        if ( $options===null ) { $options=[]; }
        $Code_tag_campagne = round($Code_tag_campagne);
        $retour = array();
    ...
    public function mf_get_2(int $Code_tag_campagne, ?array $options = null /* $options = [ 'autocompletion' => AUTOCOMPLETION_DEFAUT, 'toutes_colonnes' => true, 'maj' => true ] */)
    {
        if ( $options===null ) { $options=[]; }
        $Code_tag_campagne = round($Code_tag_campagne);
        $retour = array();
    ...
    public function mf_prec_et_suiv( int $Code_tag_campagne, ?array $options = null /* $options = [ 'cond_mysql' => [], 'tris' => [], 'limit' => [], 'toutes_colonnes' => TOUTES_COLONNES_DEFAUT, 'autocompletion' => AUTOCOMPLETION_DEFAUT, 'controle_acces_donnees' => CONTROLE_ACCES_DONNEES_DEFAUT, 'maj' => true ] */)
    {
        if ( $options===null ) { $options=[]; }
        $Code_tag_campagne = round($Code_tag_campagne);
    ...
    public function mf_liste_Code_tag_campagne(?array $options = null /* $options = [ 'cond_mysql' => array() ] */)
    {
        if ( $options===null ) { $options=[]; }
    ...
    public function mf_search_tag_campagne_Libelle( string $tag_campagne_Libelle )
    {
