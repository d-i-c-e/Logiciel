...
if ( !$cache->start() )
{
    ...
    /* Chargement des actions */
        include __DIR__ . '/code/_a_candidature_joueur_groupe_actions.php';
    ...
    /* Chargement des forms */
        include __DIR__ . '/code/_a_candidature_joueur_groupe_form.php';

    $menu_a_droite->ajouter_bouton_deconnexion();

    echo recuperer_gabarit('main/page.html', array(
            '{titre_page}' => 'a_candidature_joueur_groupe',
            '{css}' => $css,
            '{js}' => $js,
            '{menu_principal}' => $menu,
