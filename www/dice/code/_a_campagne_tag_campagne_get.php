<?php
    ...
    /* prec_et_suiv */
    if ( $table_a_campagne_tag_campagne->mf_compter((isset($est_charge['tag_campagne']) ? $mf_contexte['Code_tag_campagne'] : 0), (isset($est_charge['campagne']) ? $mf_contexte['Code_campagne'] : 0))<100 )
    {
    ...
    {
        $trans['{pager_a_campagne_tag_campagne}'] = '';
    }
