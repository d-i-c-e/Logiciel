<?php
    ...
    /* prec_et_suiv */
    if ( $table_a_invitation_joueur_groupe->mf_compter((isset($est_charge['joueur']) ? $mf_contexte['Code_joueur'] : 0), (isset($est_charge['groupe']) ? $mf_contexte['Code_groupe'] : 0))<100 )
    {
    ...
    {
        $trans['{pager_a_invitation_joueur_groupe}'] = '';
    }
